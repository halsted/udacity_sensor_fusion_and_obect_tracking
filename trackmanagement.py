...
class Track:
    ...
    def __init__(self, meas, id):
        ...
        # from Initialization Exercise Solution (Multi-target Tracking module 6)        
        # transform measurement to vehicle coordinates
        pos_sens = np.matrix(np.ones((4, 1))) # homogeneous coordinates
        ...
        for i in unassigned_tracks:
            ...
            if meas_list: # if not empty
                if meas_list[0].sensor.in_fov(track.x):                    
                    # your code goes here
                    # With help from https://knowledge.udacity.com/questions/891850
